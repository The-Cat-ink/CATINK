  ...
  <form id="formPublicacion" enctype="multipart/form-data">
    ...
    <div class="cn-wrap">
      ...
      <div class="cn-section" id="sec-rating">
        <div class="cn-section-header">
          <div class="cn-section-icon" style="font-size:15px;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="1em" height="1em" fill="currentColor" aria-hidden="true"><ellipse cx="50" cy="72" rx="22" ry="17"/><ellipse cx="18" cy="47" rx="10" ry="14" transform="rotate(-25 18 47)"/><ellipse cx="36" cy="30" rx="10" ry="14"/><ellipse cx="64" cy="30" rx="10" ry="14"/><ellipse cx="82" cy="47" rx="10" ry="14" transform="rotate(25 82 47)"/></svg></div>
          <div>
        ...
        <div class="cn-section-body">
          <div class="cn-field">
            ...
            <div class="cn-star-rating" id="starRating">
              ...
              <input type="radio" name="calificacion" id="star1" value="1" checked>
              <label for="star1" title="1 — Baja relevancia"><?= $pawSvg ?></label>
            </div>
            <div class="cn-hint" id="ratingHint">Seleccionado: 1 de 5 Patitas — Baja relevancia</div>
          </div>
        </div>
      </div><!-- /sec-rating -->
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.querySelectorAll('input[name="calificacion"]').forEach(radio => {
    radio.addEventListener('change', () => {
      ...
      if (hint) hint.textContent = `Seleccionado: ${radio.value} de 5 Patitas — ${ratingLabels[radio.value]}`;
    });
  });
