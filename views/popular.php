...
// SEO DINÁMICO
// ==============================
$pageTitle = "Lo más popular";
$pageDescription = "Las noticias más populares y vistas de todos los tiempos en CatInk.";
...
<div class="container mt-5">
  <div class="container-fluid">
      ...
      <div class="mb-4">
          <h1 style="font-weight: 800; font-size: 2rem;">Lo más popular</h1>
          <p class="text-muted" style="font-size: 1.1rem;">Las noticias más vistas de todos los tiempos</p>
      </div>
    <div class="row">
