...
// SEO DINÁMICO
// ==============================
$pageTitle = "Lo más nuevo - CatInk";
$pageDescription = "Explora todo el contenido de CatInk ordenado desde lo más nuevo a lo más antiguo en tiempo real.";
    ...
    <div class="col-lg-9 col-md-8 col-12">
      <?php if ($result->num_rows === 0): ?>
        <div class="p-5 text-center" style="background: var(--card-bg); border-radius: 16px; border: 1px solid var(--border);">
          ...
          <p class="mt-3 text-muted" style="font-size: 1.1rem;">No se encontraron noticias publicadas recientemente.</p>
        </div>
      <?php else: ?>
