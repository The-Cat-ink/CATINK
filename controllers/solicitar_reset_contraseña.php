...
if (empty($email)) {
    header("Location: ./../views/olvide_contraseña.php?error=El correo es requerido");
    exit();
}

// Validar que sea un email válido
if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
    header("Location: ./../views/olvide_contraseña.php?error=Correo inválido");
    exit();
}
...
if (!$usuario) {
    header("Location: ./../views/olvide_contraseña.php?mensaje=Si el correo existe en nuestro sistema, recibirás un enlace de recuperación");
    exit();
}
...
try {
    ...
    header("Location: ./../views/olvide_contraseña.php?error=Error al enviar el correo. Intenta más tarde");
    exit();
}
?>
